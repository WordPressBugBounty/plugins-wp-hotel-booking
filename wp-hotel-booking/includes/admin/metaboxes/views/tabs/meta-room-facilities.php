			...
			foreach ( $facilities as $fac_key => $facility ) {
                ...
                <div class="_hb_room_fac_panel">
                    <div class="_hb_room_fac_panel_title">
                        ...
                        <span class="_hb_room_fac_panel_title_text">
                            <?php
                            if ( isset( $facility['label'] ) ) {
	                            echo esc_html( $facility['label'] );
                            }
                            ?>
                        </span>
                    ...
                    <div class="_hb_room_fac_panel_content">
                        <div class="_hb_room_fac_label form-field">
                            ...
                            <div class="hb-form-field-input">
                                <input type="text" name="_hb_room_fac_label[]"
                                       value="<?php echo esc_attr( $facility['label'] ); ?>">
                            </div>
                        </div>
								...
								foreach ( $attrs as $attr ) {
                                    ...
                                    <div class="_hb_fac_attr_panel">
                                        <div class="_hb_fac_attr_panel_title">
                                            <i class="dashicons dashicons-move"></i>
                                            <span class="_hb_fac_attr_panel_title_text">
                                                <?php
                                                if ( isset( $attr['label'] ) ) {
                                        ...
                                        <div class="_hb_fac_attr_panel_content">
                                            <div class="_hb_fac_attr_label form-field">
                                                ...
                                                <div class="hb-form-field-input">
													...
													?>
                                                    <input type="text"
                                                           name="<?php echo esc_attr( $fac_attr_label_name ); ?>"
                                                           value="<?php echo esc_attr( $fac_attr_label_value ); ?>">
                                                </div>
                                            </div>
											<?php
            ...
            <div class="_hb_room_fac_panel_content">
                ...
                <div class="_hb_fac_attr form-field">
                    ...
                    <div class="_hb_fac_attr_inner">
                        ...
                        <!--                                <div class="_hb_fac_attr_label form-field">-->
                        <!--                                    <label>-->
						<?php //esc_attr_e( 'Label', 'wp-hotel-booking' ); ?><!--</label>-->
                        <!--                                    <div class="hb-form-field-input">-->
